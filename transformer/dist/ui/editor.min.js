...
var goVariantsEditor = function goVariantsEditor(editorOptions) {
	editorOptions = _extends({ rootId: 'sgfEditor', showExtras: true, inhibitForRoot: true }, editorOptions);
	...
	var _editorOptions = editorOptions,
	    ...
	    getElementByIdSuffix = function getElementByIdSuffix(suffix) {
	...
	//startup
	var optionsNode = document.querySelectorAll('#' + rootId + ' .go-variants-options');
	if (optionsNode.length > 0) {
		var options = JSON.parse(optionsNode[0].innerText);
		editorOptions = _extends({}, editorOptions, options);
	}
