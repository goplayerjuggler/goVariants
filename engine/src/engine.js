...
module.exports = function (options) {
    ...
    function myIndexOf(a,b) {
		return _fi(a, function(x){ return _.isEqual(x,b)});
	}
	...
	$.exportData = function() {
		return {
		blackStones : _.map($.board.blackStones, _.clone),
		
		whiteStones : _.map($.board.whiteStones, _.clone),
		captured : _.clone($.board.captured),
    ...
    $.play = function (playerColour, point) {
		...
		*/
        ...
        return {removed:removed, suicide:suicide}
    }
